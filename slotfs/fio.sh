...
LD_PRELOAD=build/libslot.so fio -filename=\\fio-test -fallocate=none -direct=0 -iodepth 1 -rw=write -ioengine=sync -bs=1k -overwrite=1 -size=2G -name=test -thread -numjobs=1
